...
export const BUCKETS = {
  ...
  CLASSES: {
    DEATH_KNIGHT: { params: [{ key: 'classId', value: CLASSES.DEATH_KNIGHT }], classes: [CLASSES.DEATH_KNIGHT.id] },
    DEMON_HUNTER: { params: [{ key: 'classId', value: CLASSES.DEMON_HUNTER }], classes: [CLASSES.DEMON_HUNTER.id] },
    DRUID: { params: [{ key: 'classId', value: CLASSES.DRUID }], classes: [CLASSES.DRUID.id] },
    HUNTER: { params: [{ key: 'classId', value: CLASSES.HUNTER }], classes: [CLASSES.HUNTER.id] },
    MAGE: { params: [{ key: 'classId', value: CLASSES.MAGE }], classes: [CLASSES.MAGE.id] },
    PALADIN: { params: [{ key: 'classId', value: CLASSES.PALADIN }], classes: [CLASSES.PALADIN.id] },
    PRIEST: { params: [{ key: 'classId', value: CLASSES.PRIEST }], classes: [CLASSES.PRIEST.id] },
    ROGUE: { params: [{ key: 'classId', value: CLASSES.ROGUE }], classes: [CLASSES.ROGUE.id] },
    SHAMAN: { params: [{ key: 'classId', value: CLASSES.SHAMAN }], classes: [CLASSES.SHAMAN.id] },
    WARLOCK: { params: [{ key: 'classId', value: CLASSES.WARLOCK }], classes: [CLASSES.WARLOCK.id] },
